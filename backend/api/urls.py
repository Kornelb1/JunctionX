...
admin.site.site_title = _("Sustainable Challenges")
admin.site.site_header = _("Sustainable Challenges Administration")
...
urlpatterns = [
    ...
    path(
        ...
        lambda _: HttpResponse(
            ...
            'auto;"><p>"<strong>200 OK.</strong> Welcome to the Sustainable Challenges API."</p></div>',
